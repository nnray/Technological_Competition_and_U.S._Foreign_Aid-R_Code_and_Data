...
=======
#fe model
>>>>>>> 761d2e536aea98bd0764a07f5b5f503837efde35
...
#sumtable(data_sum,group="country",group.long=FALSE,summ = c('mean(x)','sd(x)'),summ.names = c("Mean","SD"),digits = 1,labels = labs,title = "")4
