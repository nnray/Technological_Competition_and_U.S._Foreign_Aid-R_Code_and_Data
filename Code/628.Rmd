...
dsp_plot2<-ggplot(data,aes(dsp))+geom_histogram(aes(dsp), position="identity", linetype=1,fill="gray60", data = data, alpha=0.5, bins = 30) + scale_y_continuous(expand = c(0,0))+labs(title = "Average Marginal Effect of Internet Freedom on Logged U.S. Foreign Aid", subtitle = "Slope = 0.0206, meaning a one unit increase in internet freedom associated with a 2.06 percent increase in U.S. aid", x="Internet Freedom",y="Left: Count, Right: Logged U.S. Foreign Aid")
