...
#trying to combine hist and effects plots
#dsp_plot2<-ggplot(data=data,mapping = aes(x=dsp))+geom_histogram(aes(dsp), position="identity", linetype=1,
                                #fill="gray60", data = data, alpha=0.5, bins = 30) + scale_y_continuous(expand = c(0,0))
#library(gtable)
#library(grid)
#grid.newpage()
#g1 <- ggplot_gtable(ggplot_build(dsp_plot))
#g2 <- ggplot_gtable(ggplot_build(dsp_plot2))
