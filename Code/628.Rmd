...
dsp_plot<-dsp_plot+labs(title = "Average Marginal Effect of Internet Freedom on Logged U.S. Foreign Aid", subtitle = "Slope = 0.0206, meaning a one unit increase in internet freedom associated with a 2.06 percent increase in U.S. aid", x="Internet Freedom",y="Logged U.S. Foreign Aid")
dsp_plot<-dsp_plot+geom_rug(data=data, mapping=aes(x=dsp))
...
caid_plot<-caid_plot+geom_rug(data=data, mapping=aes(x=log_caid))
#Masa's code
